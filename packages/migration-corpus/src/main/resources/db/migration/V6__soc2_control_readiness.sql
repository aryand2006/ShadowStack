...
VALUES
  ...
  ('a1000000-0000-4000-8000-00000000000b', 'DOC', 'DOC',
   ...
   '00000000-0000-4000-8000-000000000001'),
  ('a1000000-0000-4000-8000-00000000000c', 'DOC', 'DOC',
   'docs/soc2-auditor-pack.md', NOW(),
   '00000000-0000-4000-8000-000000000001'),
  ('a1000000-0000-4000-8000-00000000000d', 'SCRIPT', 'SCRIPT',
   'scripts/export-soc2-evidence.sh', NOW(),
   '00000000-0000-4000-8000-000000000001'),
  ('a1000000-0000-4000-8000-00000000000e', 'DOC', 'DOC',
   'docs/secrets-and-encryption.md', NOW(),
   '00000000-0000-4000-8000-000000000001'),
  ('a1000000-0000-4000-8000-00000000000f', 'DOC', 'DOC',
   'docs/web-security.md', NOW(),
   '00000000-0000-4000-8000-000000000001'),
  ('a1000000-0000-4000-8000-000000000010', 'CODE', 'CODE',
   'apps/api/src/main/java/com/shadowstack/api/crypto/AesGcmEncryptionService.java', NOW(),
   '00000000-0000-4000-8000-000000000001'),
  ('a1000000-0000-4000-8000-000000000011', 'CI', 'CI',
   '.github/workflows/ci.yml#web-npm-audit', NOW(),
   '00000000-0000-4000-8000-000000000001')
