...
/** javax.servlet → jakarta.servlet package migration (Jakarta EE). */
public class JavaxToJakartaServletRule implements RefactorRule {
    private static final String RULE_ID = "JAVAX_SERVLET_TO_JAKARTA";
    private static final String FROM = "javax.servlet";
    private static final String TO = "jakarta.servlet";

    @Override public String ruleId() { return RULE_ID; }
    @Override public String ruleName() { return "javax.servlet → jakarta.servlet"; }
    @Override public String description() {
        return "Migrates imports/types from javax.servlet to jakarta.servlet.";
    }
