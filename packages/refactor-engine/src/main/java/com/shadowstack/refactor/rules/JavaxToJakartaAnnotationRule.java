...
/** javax.annotation → jakarta.annotation package migration (Jakarta EE). */
public class JavaxToJakartaAnnotationRule implements RefactorRule {
    private static final String RULE_ID = "JAVAX_ANNOTATION_TO_JAKARTA";
    private static final String FROM = "javax.annotation";
    private static final String TO = "jakarta.annotation";

    @Override public String ruleId() { return RULE_ID; }
    @Override public String ruleName() { return "javax.annotation → jakarta.annotation"; }
    @Override public String description() {
        return "Migrates imports/types from javax.annotation to jakarta.annotation.";
    }
    ...
    public boolean appliesTo(ASTNode node, SemanticContext context) {
        if (node instanceof ImportDeclaration imp) {
            ...
            if (q.startsWith("javax.annotation.processing")) return false;
